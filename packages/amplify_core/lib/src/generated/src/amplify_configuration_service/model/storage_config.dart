...
sealed class StorageConfig extends _i1.SmithyUnion<StorageConfig> {
  ...
  factory StorageConfig.s3({required List<StorageS3Bucket> buckets}) =>
      StorageConfigS3$(StorageS3Config(buckets: buckets));
    ...
    switch (key) {
      case 's3':
        return StorageConfigS3$((serializers.deserialize(
          value,
          specifiedType: const FullType(StorageS3Config),
        ) as StorageS3Config));
    }
