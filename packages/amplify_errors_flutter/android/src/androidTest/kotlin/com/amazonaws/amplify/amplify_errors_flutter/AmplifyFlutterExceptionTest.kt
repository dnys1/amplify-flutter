...
class AmplifyFlutterExceptionTest {
    ...
    fun test_amplify_exception() {
        ...
        assertEquals(
            ...
            "com.amazonaws.amplify.amplify_errors_flutter.DummyAmplifyException"
        )
    ...
    fun test_nested_amplify_amplify_exception() {
        ...
        assertEquals(
            flutterException.code,
            "com.amazonaws.amplify.amplify_errors_flutter.DummyAmplifyException_com.amazonaws.amplify.amplify_errors_flutter.DummyAmplifyException"
        )
        assertEquals(flutterException.message, dummyMessage)
        assertEquals(flutterException.recoverySuggestion, dummyRecoverySuggestion)
    ...
    fun test_nested_amplify_amazon_exception() {
        ...
        assertEquals(
            flutterException.code,
            "com.amazonaws.amplify.amplify_errors_flutter.DummyAmplifyException_com.amazonaws.amplify.amplify_errors_flutter.DummyAmazonClientException"
        )
        assertEquals(flutterException.message, dummyMessage)
        assertEquals(flutterException.recoverySuggestion, dummyRecoverySuggestion)
