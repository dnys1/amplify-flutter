...
import 'package:amplify_auth_cognito_common/src/constants.dart';
import 'package:amplify_auth_cognito_common/src/helpers.dart';
import 'package:amplify_auth_cognito_common/src/flows/srp/srp_helper.dart';
import 'package:amplify_auth_cognito_common/src/flows/srp/srp_init_result.dart';
import 'package:amplify_auth_cognito_common/src/model/cognito_device_secrets.dart';
import 'package:amplify_auth_cognito_common/src/model/sign_in_parameters.dart';
...
abstract class SrpDevicePasswordVerifierWorker extends WorkerBeeBase<
  ...
  SrpDevicePasswordVerifierWorker() : super(serializers: _serializers);
