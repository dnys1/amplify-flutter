...
Future<void> testWorker({
  ...
  await worker.spawn(jsEntrypoint: jsEntrypoint, loadJsEntrypoint: loader);
...
Future<void> testWorkerNoResult({
  String? jsEntrypoint,
  Future<String> Function()? loader,
}) async {
  final message = createMessage();
...
Future<void> testWorkerNullResult({
  String? jsEntrypoint,
  Future<String> Function()? loader,
}) async {
  final message = createMessage();
...
Future<void> testWorkerVoidResult({
  String? jsEntrypoint,
  Future<String> Function()? loader,
}) async {
  final message = createMessage();
