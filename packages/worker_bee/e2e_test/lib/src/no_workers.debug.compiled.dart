...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    ListBuilder_ListBuilder(iterable, $E) {
      ...
      if (t2._is(iterable)) {
        ...
        t1.set$__ListBuilder__list(t3._as(A.List_List$from(iterable, true, $E)));
    ...
    BlobInitOptions: function BlobInitOptions() {
    },
    JSObject: function JSObject() {
    },
    MessagePortChannel: function MessagePortChannel(t0, t1) {
      this._done = t0;
      this.$ti = t1;
    },
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 5:
              ...
              workers.$index(0, assignment.role);
              t1 = A.StateError$("No worker found for role: " + assignment.toString$0(0));
              throw A.wrapException(t1);
              // goto join
              $async$goto = 3;
              break;
  ...
  A._SyncCompleter.prototype = {
    complete$1(_, value) {
      ...
      if ((t2._state & 30) !== 0)
        throw A.wrapException(A.StateError$("Future already completed"));
      t3 = t2.$ti;
      value = t3._eval$1("1/")._as(t1._eval$1("1/")._as(value));
      if (t3._eval$1("Future<1>")._is(value))
        if (t3._is(value))
          A._Future__chainCoreFuture(value, t2);
        else
          t2._chainForeignFuture$1(value);
      else {
        listeners = t2._removeListeners$0();
        t3._precomputed1._as(value);
        t2._state = 8;
        t2._resultOrListeners = value;
        A._Future__propagateToListeners(t2, listeners);
      }
    },
    _completeError$2(error, stackTrace) {
  ...
  A.ListBuilder.prototype = {
    get$length(_) {
      return A._lateReadCheck(this.__ListBuilder__list, "_list").length;
    },
  ...
  A.ListMultimapBuilder.prototype = {
    ...
    _getValuesBuilder$1(key) {
      var result, builtValues, _this = this,
        ...
        t1 = _this.$ti;
      t1._precomputed1._as(key);
      result = A._lateReadCheck(_this.__ListMultimapBuilder__builderMap, _s11_).$index(0, key);
      if (result == null) {
        builtValues = A._lateReadCheck(_this.__ListMultimapBuilder__builtMap, "_builtMap").$index(0, key);
        ...
        A._lateReadCheck(_this.__ListMultimapBuilder__builderMap, _s11_).$indexSet(0, key, result);
      }
      return result;
    },
    _list_multimap$_setWithCopyAndCheck$2(keys, lookup) {
      var t1, t2, t3, t4, key, t5, value, t6, t7, t8, _this = this, _null = null;
      _this.set$_list_multimap$_builtMapOwner(_null);
      t1 = _this.$ti;
      t2 = t1._precomputed1;
      _this.set$__ListMultimapBuilder__builtMap(t1._eval$1("Map<1,BuiltList<2>>")._as(A.LinkedHashMap_LinkedHashMap$_empty(t2, t1._eval$1("BuiltList<2>"))));
          ...
          for (t5 = J.get$iterator$ax(t4._as(lookup.call$1(key))); t5.moveNext$0();) {
            ...
            if (t1._is(value)) {
              ...
              if (t6._listOwner != null) {
                t6.set$__ListBuilder__list(t7._eval$1("List<1>")._as(A.List_List$from(A._lateReadCheck(t6.__ListBuilder__list, "_list"), true, t8)));
                t6.set$_listOwner(_null);
              }
              B.JSArray_methods.add$1(A._lateReadCheck(t6.__ListBuilder__list, "_list"), value);
            } else
  ...
  A.MapBuilder.prototype = {
    ...
    $indexSet(_, key, value) {
      ...
      A._lateReadCheck(_this.__MapBuilder__map, "_map").$indexSet(0, key, value);
    },
    get$length(_) {
  ...
  A.SetMultimapBuilder.prototype = {
    ...
    _setWithCopyAndCheck$2(keys, lookup) {
      var t1, t2, t3, t4, t5, key, t6, value, result, builtValues, t7, t8, _this = this, _null = null,
        _s11_ = "_builderMap";
      _this.set$_builtMapOwner(_null);
      t1 = _this.$ti;
      t2 = t1._precomputed1;
      _this.set$__SetMultimapBuilder__builtMap(t1._eval$1("Map<1,BuiltSet<2>>")._as(A.LinkedHashMap_LinkedHashMap$_empty(t2, t1._eval$1("BuiltSet<2>"))));
      t3 = t1._eval$1("SetBuilder<2>");
      _this.set$__SetMultimapBuilder__builderMap(t1._eval$1("Map<1,SetBuilder<2>>")._as(A.LinkedHashMap_LinkedHashMap$_empty(t2, t3)));
        ...
        if (t2._is(key))
          for (t6 = J.get$iterator$ax(t5._as(lookup.call$1(key))); t6.moveNext$0();) {
            ...
            if (t1._is(value)) {
              ...
              result = A._lateReadCheck(_this.__SetMultimapBuilder__builderMap, _s11_).$index(0, key);
              if (result == null) {
                builtValues = A._lateReadCheck(_this.__SetMultimapBuilder__builtMap, "_builtMap").$index(0, key);
                if (builtValues == null) {
                  result = new A.SetBuilder(_null, $, _null, t3);
                  result.replace$1(0, B.List_empty0);
                } else {
                  t7 = builtValues.$ti;
                  t7._eval$1("_BuiltSet<1>")._as(builtValues);
                  result = new A.SetBuilder(builtValues._setFactory, builtValues._set$_set, builtValues, t7._eval$1("SetBuilder<1>"));
                }
                A._lateReadCheck(_this.__SetMultimapBuilder__builderMap, _s11_).$indexSet(0, key, result);
              }
              t7 = result.$ti;
              t8 = t7._precomputed1;
              t8._as(value);
              ...
              if (result._setOwner != null) {
                ...
                t8.addAll$1(0, A._lateReadCheck(result.__SetBuilder__set, "_set"));
                result.set$__SetBuilder__set(t7._eval$1("Set<1>")._as(t8));
                result.set$_setOwner(_null);
              }
              A._lateReadCheck(result.__SetBuilder__set, "_set").add$1(0, value);
            } else
              throw A.wrapException(A.ArgumentError$("map contained invalid value: " + A.S(value) + ", for key " + A.S(key), _null));
          }
        else
  ...
  A.BuiltJsonSerializersBuilder.prototype = {
    ...
    build$0() {
      ...
      if (t5._listOwner == null) {
        t6 = A._lateReadCheck(t5.__ListBuilder__list, "_list");
        t7 = t5.$ti;
        t8 = t7._eval$1("_BuiltList<1>");
        t8 = t8._as(new A._BuiltList(t6, t8));
        t5.set$__ListBuilder__list(t7._eval$1("List<1>")._as(t6));
  ...
  A._$WorkerBeeExceptionImpl.prototype = {
    ...
    get$hashCode(_) {
      var t1 = A.$jc(A.$jc(0, B.JSString_methods.get$hashCode(this.error)), J.get$hashCode$(this.stackTrace)),
  ...
  A.URL.prototype = {};
  A.Blob0.prototype = {};
  A.BlobInitOptions.prototype = {};
  A.JSObject.prototype = {};
  A.MessagePortChannel.prototype = {$isStreamChannel: 1};
  A._MessagePortChannel_Object_StreamChannelMixin.prototype = {};
  A.getWorkerAssignment_onError.prototype = {
    call$2(e, st) {
      var t1 = self.self,
        t2 = A._convertToJs($.$get$workerBeeSerializers().serialize$2$specifiedType(e, B.FullType_null_List_empty_false));
      t1.postMessage.apply(t1, [t2, null]);
    },
    $signature: 10
  };
  A.getWorkerAssignment_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.WorkerAssignment),
        $async$returnValue, t1, eventListener, t2, t3;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = self.self;
              t3 = $.Zone__current.bindUnaryCallback$2$1(new A.getWorkerAssignment__closure(eventListener, new A._SyncCompleter(t1, type$._SyncCompleter_WorkerAssignment)), type$.void, type$.JavaScriptObject);
              eventListener._value = t3;
              t2.addEventListener("message", A.allowInterop(t3, type$.Function), false);
  ...
  A.getWorkerAssignment__closure.prototype = {
    call$1($event) {
      ...
      if (typeof message == "string" && t1._is(messagePort)) {
        t1 = self.self;
        t2 = this.eventListener;
        t3 = t2._value;
        if (t3 === t2)
          A.throwExpression(new A.LateError("Local '" + t2._name + "' has not been initialized."));
        t1.removeEventListener("message", A.allowInterop(t3, type$.Function), false);
        t1 = $.Zone__current;
        $.$get$workerBeeSerializers();
        this.assignmentCompleter.complete$1(0, new A.WorkerAssignment(message, new A.MessagePortChannel(new A._AsyncCompleter(new A._Future(t1, type$._Future_void), type$._AsyncCompleter_void), type$.MessagePortChannel_LogMessage)));
      } else
        this.assignmentCompleter.completeError$1(new A.StateError("Invalid worker assignment: " + A.S($.$get$workerBeeSerializers().serialize$1(message))));
    },
    $signature: 51
  };
  A._$LogLevelSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      type$.LogLevel._as(object);
  ...
  A._$LogMessageSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      result = ["workerName", serializers.serialize$2$specifiedType(object.get$workerName(), B.FullType_h8g), "message", serializers.serialize$2$specifiedType(object.get$message(object), B.FullType_h8g), "local", serializers.serialize$2$specifiedType(object.get$local(), B.FullType_MtR), "level", serializers.serialize$2$specifiedType(object.get$level(object), B.FullType_A91)];
      value = object.get$error(object);
      result.push("error");
      result.push(serializers.serialize$2$specifiedType(value, B.FullType_1MH));
      value = object.get$stackTrace();
      result.push("stackTrace");
      result.push(serializers.serialize$2$specifiedType(value, B.FullType_j4A));
      return result;
    },
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 62, 0);
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 63, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 64, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 65, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 66, 0);
  ...
  (function inheritance() {
    ...
    _inheritMany(J.LegacyJavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, A.Window0, A.Event0, A.EventTarget0, A.Location0, A.WorkerInit, A.MessageChannel0, A.JSON, A.URL, A.Blob0, A.BlobInitOptions, A.JSObject]);
    ...
    _inheritMany(A.Closure, [A.Instantiation, A.Closure2Args, A.Closure0Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A._CustomZone_bindUnaryCallback_closure, A._RootZone_bindUnaryCallback_closure, A.runZonedGuarded_closure, A._BigIntImpl_hashCode_finish, A._Uri__makePath_closure, A._createTables_setChars, A._createTables_setRange, A.BuiltListMultimap_BuiltListMultimap_closure, A.BuiltListMultimap_hashCode_closure, A.ListMultimapBuilder_replace_closure, A.BuiltMap_BuiltMap_closure, A.BuiltMap_hashCode_closure, A.BuiltSet_hashCode_closure, A.SetMultimapBuilder_replace_closure, A.newBuiltValueToStringHelper_closure, A.BuiltListMultimapSerializer_serialize_closure, A.BuiltListSerializer_serialize_closure, A.BuiltSetMultimapSerializer_serialize_closure, A.BuiltSetSerializer_serialize_closure, A.Context_joinAll_closure, A.Context_split_closure, A._validateArgList_closure, A.WindowsStyle_absolutePathToUri_closure, A.Chain_Chain$parse_closure, A.Chain_Chain$parse_closure0, A.Chain_Chain$parse_closure1, A.Chain_toTrace_closure, A.Chain_toString_closure0, A.Chain_toString__closure0, A.Chain_toString_closure, A.Chain_toString__closure, A.Trace__parseVM_closure, A.Trace__parseVM_closure0, A.Trace$parseV8_closure, A.Trace$parseV8_closure0, A.Trace$parseJSCore_closure, A.Trace$parseJSCore_closure0, A.Trace$parseFirefox_closure, A.Trace$parseFirefox_closure0, A.Trace$parseFriendly_closure, A.Trace$parseFriendly_closure0, A.Trace_terse_closure, A.Trace_foldFrames_closure, A.Trace_foldFrames_closure0, A.Trace_toString_closure0, A.Trace_toString_closure, A.WorkerBeeExceptionImpl_WorkerBeeExceptionImpl_closure, A.getWorkerAssignment__closure, A.runTraced_wrappedOnError_closure]);
    _inherit(A.Instantiation1, A.Instantiation);
    _inheritMany(A.Closure2Args, [A.Primitives_functionNoSuchMethod_closure, A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A._Future__chainForeignFuture_closure0, A.HashMap_HashMap$from_closure, A.MapBase_mapToString_closure, A.NoSuchMethodError_toString_closure, A._BigIntImpl_hashCode_combine, A.Uri__parseIPv4Address_error, A.Uri_parseIPv6Address_error, A.Uri_parseIPv6Address_parseHex, A._createTables_build, A.MidiInputMap_keys_closure, A.MidiOutputMap_keys_closure, A.RtcStatsReport_keys_closure, A.Storage_keys_closure, A.AudioParamMap_keys_closure, A.hashObjects_closure, A.MapBuilder_replace_closure, A.Frame_Frame$parseV8_closure_parseLocation, A.getWorkerAssignment_onError, A.runTraced_wrappedOnError]);
    ...
    _inheritMany(A.EventTarget0, [A.GlobalScope, A.MessagePort0, A.Worker0]);
    _inheritMany(A.Event0, [A.MessageEvent0, A.ErrorEvent0]);
...
;
    ...
    B.Map_empty = new A.ConstantStringMap(0, {}, B.List_empty, A.findType("ConstantStringMap<String,WorkerBeeBase<Object,@>()>"));
    B.List_empty2 = A._setArrayType(makeConstList([]), A.findType("JSArray<Symbol0>"));
    B.Map_empty1 = new A.ConstantStringMap(0, {}, B.List_empty2, A.findType("ConstantStringMap<Symbol0,@>"));
    B.Map_empty0 = new A.ConstantStringMap(0, {}, B.List_empty0, A.findType("ConstantStringMap<@,@>"));
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_runtimeType", "$get$_runtimeType", () => A.getRuntimeType(A.RegExp_RegExp("", false)));
...
//# sourceMappingURL=no_workers.debug.dart.js.map
